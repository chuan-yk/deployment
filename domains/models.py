...
class DomainList(models.Model):
    ...
    encryption = models.IntegerField(default=0, help_text="HTTPS使用状态： 0-未使用， 1-使用中， 2-即将过期， 3-已过期, 4-连接不通")
    ...
    update_time = models.DateField(null=True, blank=True, help_text='域名解析时间')

...
class RecordOfjavajar(models.Model):
    ...
    pub_filemd5sum = models.CharField(max_length=50, default='')  # 上传文件的MD5 值
    new_filemd5sum = models.CharField(max_length=50, default='')  # 新Jar包的MD5 值
    ...
    jarfilename = models.CharField(max_length=200, default='')  # 更新的jar包名
    backupsavedir = models.CharField(max_length=200, default='')  # 备份所在目录
    changefiles = models.CharField(max_length=7000, default='')  # 更新文件列表
